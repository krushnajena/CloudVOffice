...
namespace Project.Management.Controllers
{
    ...
    public class PROJECTMANAGEMENTController: Controller
    {
        ...
        private readonly string InstationPath = "Project.Management";
        public PROJECTMANAGEMENTController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
