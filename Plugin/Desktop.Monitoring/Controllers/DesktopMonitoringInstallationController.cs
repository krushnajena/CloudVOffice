...
namespace Desktop.Monitoring.Controllers
{
	...
	public class DesktopMonitoringInstallationController : Controller
	{
		...
		private readonly string InstationPath = "Desktop.Monitoring";

		public DesktopMonitoringInstallationController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
