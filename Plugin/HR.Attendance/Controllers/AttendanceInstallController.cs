...
namespace HR.Attendance.Controllers
{
    ...
    public class AttendanceInstallController : Controller
    {
        ...
        private readonly string InstationPath = "HR.Attendance";

        public AttendanceInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
