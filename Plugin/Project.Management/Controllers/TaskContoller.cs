...
namespace Project.Management.Controllers
{
    ...
    public class TaskController : BasePluginController
    {
        ...
        public IActionResult MyTaskDelayList()
        {
            ...
            var projectTasks = _projectTaskService.GetMyTaskDelayList(EmployeeId);
            var data = from u in projectTasks
                       select new
                       {
        ...
        public IActionResult ProjectTaskSummeryReport()
        {
            ...
            ViewBag.report = _projectService.ProjectTaskSummeryReport(EmployeeId, UserId);
            return View("~/Plugins/Project.Management/Views/Task/ProjectTaskSummeryReport.cshtml");
        }
